...
class AuthController
{
        ...
        if (isset($_POST['submit'])) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                if (password_verify($password, $data['password'])) {
                    $_SESSION["login"] = true;
                    $_SESSION["data_mahasiswa"] = $data["data_mahasiswa"];
    ...
    private function generateNIM($id_pendaftaran){
        ...
        //      - Buat variabel $nim dengan nilai NIM dengan format: [kode_jurusan][tahun][id_pendaftaran]. Opsional: Gunakan str_pad() untuk id_pendaftaran
